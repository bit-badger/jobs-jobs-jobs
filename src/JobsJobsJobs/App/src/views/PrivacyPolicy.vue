<template>
  <article>
    ...
    <p>
      ...
      &ldquo;Service&rdquo;) alongside our application, {{name}}. By accessing or using our Service, you signify that
    ...
    <p>
      ...
      the browser&rsquo;s memory, and the Service uses it on each request for data. If the page is refreshed or the
    ...
    <h5>Individual Data Subject&rsquo;s Rights - Data Access, Portability, and Deletion</h5>
    <p>
    ...
    <ul>
      ...
      <li>
        Request that a business that sells a consumer&rsquo;s personal data, not sell the consumer&rsquo;s personal
        data.
      </li>
    </ul>
    <p>
    ...
    <p class="fst-italic">
      Change on September 6<sup>th</sup>, 2021 &ndash; replaced &ldquo;No Agenda Social&rdquo; with generic terms for
